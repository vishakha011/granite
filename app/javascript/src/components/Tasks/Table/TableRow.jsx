        ...
        <tr key={rowData.id}>
          <td className="px-6 py-4 text-center">
            <input
              type="checkbox"
              checked={isCompleted}
              className="ml-6 w-4 h-4 text-bb-purple border-gray-300 rounded form-checkbox focus:ring-bb-purple cursor-pointer"
              onChange={() =>
                handleProgressToggle({
                  slug: rowData.slug,
          ...
          {!isCompleted && (
            ...
            leading-5 text-bb-gray-600 whitespace-no-wrap"
              >
                {rowData.user.name}
              </td>
